          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div className="text-center p-4 bg-gradient-to-br from-green-500/10 to-blue-500/10 rounded-xl border border-green-500/20">
                  <AnimatedCounter end={150} duration={2} suffix="+" delay={0.7} />
                  <div className="text-sm text-muted mt-2">Students Taught</div>
                </div>
                ...
                <div className="text-center p-4 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 rounded-xl border border-cyan-500/20">
                  ...
                  <div className="text-sm text-muted mt-2">Leadership Roles</div>
                </div>
              </motion.div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-5 bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-xl border border-blue-500/20 hover:from-blue-500/20 hover:to-purple-500/20 hover:border-blue-500/40 hover:scale-105 hover:shadow-lg hover:shadow-blue-500/20 transition-all duration-300 group cursor-pointer">
              ...
              <div className="p-5 bg-gradient-to-br from-green-500/10 to-emerald-500/10 rounded-xl border border-green-500/20 hover:from-green-500/20 hover:to-emerald-500/20 hover:border-green-500/40 hover:scale-105 hover:shadow-lg hover:shadow-green-500/20 transition-all duration-300 group cursor-pointer">
                <div className="flex items-center gap-3 mb-3">
              ...
              <div className="p-5 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 rounded-xl border border-cyan-500/20 hover:from-cyan-500/20 hover:to-blue-500/20 hover:border-cyan-500/40 hover:scale-105 hover:shadow-lg hover:shadow-cyan-500/20 transition-all duration-300 group cursor-pointer">
                <div className="flex items-center gap-3 mb-3">
              ...
              <div className="p-5 bg-gradient-to-br from-pink-500/10 to-purple-500/10 rounded-xl border border-pink-500/20 hover:from-pink-500/20 hover:to-purple-500/20 hover:border-pink-500/40 hover:scale-105 hover:shadow-lg hover:shadow-pink-500/20 transition-all duration-300 group cursor-pointer">
                <div className="flex items-center gap-3 mb-3">
            ...
            {/* Work Experience */}
            <div className="p-6 bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-xl border border-purple-500/20 hover:from-purple-500/20 hover:to-pink-500/20 hover:border-purple-500/40 hover:shadow-lg hover:shadow-purple-500/20 transition-all duration-300 group">
              ...
              <div className="space-y-4">
                <div className="p-4 bg-white/5 rounded-lg border border-white/10 hover:bg-white/10 hover:border-purple-500/30 hover:scale-105 hover:shadow-md hover:shadow-purple-500/10 transition-all duration-300 cursor-pointer group/item">
                ...
                <div className="p-4 bg-white/5 rounded-lg border border-white/10 hover:bg-white/10 hover:border-pink-500/30 hover:scale-105 hover:shadow-md hover:shadow-pink-500/10 transition-all duration-300 cursor-pointer group/item">
                  <div className="flex justify-between items-start mb-2">
                ...
                <div className="p-4 bg-white/5 rounded-lg border border-white/10 hover:bg-white/10 hover:border-cyan-500/30 hover:scale-105 hover:shadow-md hover:shadow-cyan-500/10 transition-all duration-300 cursor-pointer group/item">
                  <div className="flex justify-between items-start mb-2">
